...
SECRET_KEY = 'django-insecure-1i31#)%)25i8^=pqa6d)5n7&wd7&94wif=6_6_cyv0*=y1ngmi'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # Use the correct database engine
        'NAME': config('Graphdb'),                  # Database name
